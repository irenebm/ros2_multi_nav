...
def generate_launch_description():
    ...
    multi_nav_dir = get_package_share_directory('multi_nav2')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(multi_nav_dir, 'maps', 'home.yaml'),
    ...
    rviz_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(os.path.join(bringup_dir, 'launch'), 'rviz_launch.py')),
    ...
    bringup_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(os.path.join(bringup_dir, 'launch'), 'bringup_launch.py')),
